...
def main():
    ...
    backend_service_cfg = BackendServiceConfig(
        ...
        # shared with the frontend: both sides must agree, see iac/frontend/prepare_frontend.py
        disable_registration_code=getenv("GLOBAL_DISABLE_REGISTRATION_CODE", False, False) or "False",
    )
