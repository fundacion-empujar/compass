...
describe("Testing Register component", () => {
  ...
  test("should navigate to login page when login link is clicked", async () => {
    ...
    // AND the login button is found and clicked
    const loginButton = screen.getByTestId(DATA_TEST_ID.LOGIN_BUTTON);
  ...
  describe("Registration code bypass functionality", () => {
    ...
    test("should allow registration without code when GLOBAL_DISABLE_REGISTRATION_CODE is true", async () => {
      ...
      await waitFor(() => {
        expect(registerMock).toHaveBeenCalledWith(givenEmail, givenPassword, givenEmail, undefined, undefined);
      });
