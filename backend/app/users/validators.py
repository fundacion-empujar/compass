...
class AnonymousUserValidator(UserPreferencesValidator):
    ...
    async def is_invitation_code_valid(self, invitation_code: Optional[str]) -> tuple[bool, Optional[UserInvitation]]:
        ...
        # capacity is not enforced in this deployment: manual/shared invitation codes stay unlimited-use
        invitation = await self._user_invitation_repository.get_valid_invitation_by_code(invitation_code, enforce_capacity=False)
